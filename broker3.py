...
def login():
    if request.method == "POST":
        ...
        with open(os.getcwd()+"/broker3/sample.json",'r') as openfile:
            ...
            with open(os.getcwd()+"/broker3/sample.json",'w') as outfile:
        ...
        with open(os.getcwd()+'/broker3/log1.json','r') as openfile:
            json_object=json.load(openfile)
        if tname not in json_object:
        ...
        f = open(os.getcwd()+"/broker3/"+ tname + '/' + tname+str(x)+'.txt', "r")
        print(f.read())
        f = f.read()
