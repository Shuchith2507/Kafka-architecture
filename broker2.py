...
def login():
    ...
    if request.method == "POST":
        ...
        with open(os.getcwd()+"/broker2/sample.json",'r') as openfile:
            ...
            with open(os.getcwd()+"/broker2/sample.json",'w') as outfile:
        ...
        # json_dict[tname].append(msg)

        # with open(os.getcwd()+"/broker2/log.json", 'a') as temp_file:
        #     json.dump(json_dict, temp_file,indent=2)

        with open(os.getcwd()+'/broker2/log1.json','r') as openfile:
            json_object=json.load(openfile)
        if tname not in json_object:
        ...
        os.remove(os.getcwd()+"/broker1/log1.json")
        ...
        f = open(os.getcwd()+"/broker2/" + tname + '/' + tname+str(x)+'.txt', "r")
        print(f.read())
        f = f.read()
